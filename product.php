    ...
    global.onload = function () {        
				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div class="add-to-cart">
								<div class="qty-label">
									...
									<div class="input-number">
										<input type="number" value="1" id="qty_num">
							...
							<ul class="product-links">
								<li>Share:</li>
								<li><a href="https://github.com/raj60221023"><i class="fa fa-facebook"></i></a></li>
								<li><a href="https://github.com/raj60221023"><i class="fa fa-twitter"></i></a></li>
								<li><a href="https://github.com/raj60221023"><i class="fa fa-google-plus"></i></a></li>
								<li><a href="https://github.com/raj60221023"><i class="fa fa-envelope"></i></a></li>
							</ul>
		...
		<div class="section main main-raised">
			...
			<div class="container">
                ...
                $run_query = $con->query($product_query);
